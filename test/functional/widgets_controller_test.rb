...
class WidgetsControllerTest < ActionController::TestCase
  ...
  test "should create widget" do
    assert_difference('Widget.count') do
      post :create, widget: { ordinal: @widget.ordinal, section_id: @widget.section_id, style: @widget.style }
    end
  ...
  test "should update widget" do
    put :update, id: @widget, widget: { ordinal: @widget.ordinal, section_id: @widget.section_id, style: @widget.style }
    assert_redirected_to widget_path(assigns(:widget))
  end
